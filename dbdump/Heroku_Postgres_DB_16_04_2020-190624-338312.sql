...
COPY public.users (id, uname, email, pword, date_added, hash) FROM stdin;
81	user3	user3@irfanweb.heroku.com	$argon2id$v=19$m=32768,t=16,p=2$YOTZNpIFWgg3vUL4/OO9dw$cC02n7K+DWDaWnMn9ej9xKAF9RHURdqMDtDIpcIjDEo	2020-04-16 01:10:48.1587	\\x324a3359574a43583751724f646344623867593566556576367a5635757831507a53564c316c75437a75453d
...
SELECT pg_catalog.setval('public.messages_msgid_seq', 109, true);
